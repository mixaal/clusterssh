...
import net.mikc.tools.clusterssh.gui.user.impl.FakeUserInput;
...
public class TestUnitApplicationModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        install(
                new FactoryModuleBuilder().implement(UserInput.class, FakeUserInput.class).build(UserInputFactory.class)
        );
        install(
