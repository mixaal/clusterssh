...
public class MainTest {
    ...
    public void startApp() {
        ...
        app.start();
        UserInput input = app.getInputWindow();
    ...
    public void testPwdCommand() {
        ...
        assertTrue(input!=null);
        input.sendInput("pwd");
        Window userTerminal = app.getRemoteConnections().get(0).getUserTerminal().getWindow();
        Window rootTerminal = app.getRemoteConnections().get(1).getUserTerminal().getWindow();
